...
// `preenchido` é a cor de AGORA (ver `corDoPreenchimento`): VERDE cheia, amarela nos 40%, vermelha nos 15%,
// ou o degrau da barra que sobe. A quarta barra tem cor escolhida no editor, que é a de cheia dela.
...
const barras = `<div class="barras-compactas">${barra('PV', 45, 45, 'normal', '#008000')}${barra('PV', 40, 100, 'aviso', '#008000', '#ffff00')}${barra('PE', 2, 12, 'perigo', '#008000', '#ff0000')}${barra('SAN', 38, 40, 'normal', '#800080')}${barra('Torso', 1, 5, 'normal', '#808080', '#ffff00')}${barra('Torso', 2, 5, 'normal', '#808080', '#ffbf00')}${barra('Torso', 3, 5, 'aviso', '#808080', '#ff8000')}${barra('Torso', 4, 5, 'aviso', '#808080', '#ff4000')}${barra('Torso', 5, 5, 'perigo', '#808080', '#ff0000')}</div>`
