...
const barras = `<div class="barras-compactas">${barra('PV', 45, 45, 'normal', '#008000')}${barra('PV', 40, 100, 'aviso', '#008000', '#ffff00')}${barra('PV', 2, 12, 'perigo', '#008000', '#ff0000')}${barra('SAN', 38, 40, 'normal', '#800080')}${barra('PM', 5, 5, 'normal', '#000080')}${barra('PM', 4, 5, 'normal', '#000080', '#0000c0')}${barra('PM', 3, 5, 'normal', '#000080', '#0000ff')}${barra('PM', 2, 5, 'aviso', '#000080', '#4040ff')}${barra('PM', 1, 5, 'perigo', '#000080', '#8080ff')}${barra('Torso', 1, 5, 'normal', '#808080', '#ffff00')}${barra('Torso', 2, 5, 'normal', '#808080', '#ffbf00')}${barra('Torso', 3, 5, 'aviso', '#808080', '#ff8000')}${barra('Torso', 4, 5, 'aviso', '#808080', '#ff4000')}${barra('Torso', 5, 5, 'perigo', '#808080', '#ff0000')}</div>`
