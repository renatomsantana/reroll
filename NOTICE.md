...
Duas fontes do menu aparecem na lista e **não** são redistribuídas de propósito, pelo mesmo motivo:
são gratuitas apenas para uso pessoal, e empacotá-las num app publicado seria redistribuição. Quem
as tiver instaladas no Windows as vê; quem não tiver cai no reserva.
...
As duas vendem licença comercial à parte. Se um dia o Reroll precisar empacotá-las, é essa licença
