...
- **Acabamento "Resina com flor"** (pedido dele, 11/09/2026: "coloquei um exemplo de dado com uma FLOR dentro, a gnt conseguiria replicar isso?", "eu quero q ele tenha algo DENTRO do dado de vidro"). Quinto botão de acabamento na aba Estilo, ao lado de Vidro. O corpo fica translúcido na cor escolhida (55%, pintado no atlas das faces, então o NÚMERO continua opaco por cima, como o cobre da referência), e dentro do dado entram flores lilás e rosa e folhas de verdade: planos com textura desenhada no canvas, espalhados dentro da esfera inscrita e filhos da malha do dado, então giram junto quando ele rola e a física não sabe que existem (`dice3d/materials/inclusaoDeResina.ts`). Uma casca de trás com `BackSide` a 40% deixa a parede do fundo tingida em vez de mostrar a cena. O arranjo é determinístico por tipo de dado, então trocar a cor não rearruma a flor. Vale nos sete dados, na prévia da aba Estilo, na prateleira e na rolagem. O harness ganhou a fase `resina`.
